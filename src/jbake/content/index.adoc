...
See the link:pages/features.html[features page] for a brief description of each of these types.

=== Example

Read the link:pages/quickstart.html[quick start guide] for how to add FunctionalJava to your project and get started with a full example.
